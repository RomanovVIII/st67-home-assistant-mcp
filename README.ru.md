...
Версия **0.1.0** · Node.js 24 · TypeScript · [Лицензия MIT](LICENSE)
...
Три универсальных инструмента вместо отдельного инструмента для каждого устройства. Сервер работает локально через Model Context Protocol (MCP); соединения с Home Assistant открываются по запросу. Поддержка конкретной операции зависит от API вашей версии HA и прав пользователя.
